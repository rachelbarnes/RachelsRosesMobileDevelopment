...
namespace RachelBarnesMobileDevelopment.Models {
    ...
    public class ConvertDensities {
        ...
        public Func<decimal, decimal> ConvertHalfGallonToOunces = half => Math.Round((half * 64), 2);
        ...
        public Func<decimal, decimal> ConvertPintsToOunces = pint => Math.Round((pint * 16), 2);
        ...
        public Func<decimal, decimal> ConvertQuartToOunces = q => Math.Round((q * 32), 2);
        ...
        public Func<decimal, decimal> ConvertCupsToOunces = c => Math.Round((c * 8), 2);
    }
}